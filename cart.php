...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Sports Cart || SYENERGY Sports Shop</title>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="large-12">
        <?php
          ...
          echo '<p><h3>Your Sports Cart</h3></p>';
          ...
          echo "You have no items in your Sports cart.";
        }
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;clear:both;">&copy; SYENERGY Sports Shop. All Rights Reserved.</p>
        </footer>
